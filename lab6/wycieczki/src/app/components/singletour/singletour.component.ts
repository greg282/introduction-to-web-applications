...
export class SingletourComponent {
  ...
  constructor(private statetour:TourCounterService,private service:AddToCartService,private route: ActivatedRoute,private shareData:ShareTourDataService,private router:Router,private state:StateServicerService,public fire:FirebaseServiceService) {
